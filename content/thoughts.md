...
> 厉害和热心的人太多了，下次做产品一定要重点考虑让所有人能低门槛贡献。 上次发现的一个比较好的例子是 Kagi 的[设置页面](https://kagi.com/settings)，有一个 [Debug Translation] 的开关，开启之后可以显示页面上每个元素的 raw key, 这样别人贡献翻译的时候就很容易。
