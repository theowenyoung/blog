...
- [Foam](https://foambubble.github.io/foam/) + [我开发的主题](https://github.com/theowenyoung/foam-template-gatsby-theme-primer-wiki)，太爽了，所以我才这么勤快的更新wiki
...
- Shift-option-command-v：粘贴纯文本（ 不含任何格式 ），区别于直接使用 command-v 操作。
- cmd-1 将窗口切换为图标视图
- cmd-2 将窗口切换为列表视图
