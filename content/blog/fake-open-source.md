...
好消息是随后我在微信上尝试搜索更多推荐沉浸式翻译的文章，粗略估计大约有 95%的文章没有提到沉浸式翻译是开源的，只有 5%的文章用开源来形容沉浸式翻译。
...
这一点指的是沉浸式的帮助文档里提到了帮忙给 Github 项目 star：
...
我希望以上的改进措施能够解决用户的关切。同时，我也想向那些被误导以为沉浸式翻译项目是开源的但其实不是而产生受骗感觉的朋友表示歉意。我从中学到了很多东西，我很庆幸是现在学到，而不是更晚。
...
但是因为我随口问了 ChatGPT 一句， 它的回答鼓励了我，让我在这个时间做了我觉得对的事，感谢 ChatGPT。
