/** Standard HTTP status codes. */ export enum Status {
  ...
  /** RFC 7231, 6.5.11 */ RequestEntityTooLarge = 413,
  /** RFC 7231, 6.5.12 */ RequestURITooLong = 414,
  /** RFC 7231, 6.5.13 */ UnsupportedMediaType = 415,
  /** RFC 7233, 4.4 */ RequestedRangeNotSatisfiable = 416,
...
/** An HTTP status that is a informational (1XX). */ export type InformationalStatus =
  | Status.Continue
  | Status.SwitchingProtocols
  | Status.Processing
  | Status.EarlyHints;
/** An HTTP status that is a success (2XX). */ export type SuccessfulStatus =
  | Status.OK
  | Status.Created
  | Status.Accepted
  ...
  | Status.IMUsed;
/** An HTTP status that is a redirect (3XX). */ export type RedirectStatus =
  Status.MultipleChoices; // 300  | Status.MovedPermanently // 301  | Status.Found // 302  | Status.SeeOther // 303  | Status.UseProxy // 305 - DEPRECATED  | Status.TemporaryRedirect // 307  | Status.PermanentRedirect; // 308
/** An HTTP status that is a client error (4XX). */ export type ClientErrorStatus =
  | Status.BadRequest
  | Status.Unauthorized
...
/** An HTTP status that is a server error (5XX). */ export type ServerErrorStatus =
...
/** An HTTP status that is an error (4XX and 5XX). */ export type ErrorStatus =
  | ClientErrorStatus
  | ServerErrorStatus;
